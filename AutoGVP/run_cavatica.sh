...
echo "Rscript 01-annotate_variants_CAVATICA_input.R --vcf $vcf_filtered_file --multianno $multianno_file --intervar $intervar_file --autopvs1 $autopvs1_file --output $out_file --variant_summary $variant_summary_file --submission_summary $submission_summary_file"
